...
const SEARCH_API = 'https://api.themoviedb.org/3/search/movie?language=ko-KR&api_key=a047e5786421470e5226ee225453e02c&query="';
...
form.addEventListener('submit', (event) => {
    ...
    if (searchTerm !== '') {
        getMovies(SEARCH_API + searchTerm); // 검색어에 따른 영화 목록 로드
